...
{
    public class UrlRedirectSerializer : ISyncSerializer<IContent>
    {
        ...
        public string SerializerType { get { return uSyncConstants.Serailization.Redirect; } }

        public UrlRedirectSerializer()
        {
